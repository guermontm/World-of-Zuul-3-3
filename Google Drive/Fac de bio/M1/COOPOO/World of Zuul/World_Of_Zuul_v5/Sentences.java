...
public class Sentences
{
    ...
    public Sentences()
    {
       ...
       listMainAxel.add(sentenceMainMartin1);
       listMainAxel.add(sentenceMainMartin2);
       listMainAxel.add(sentenceMainMartin3);
       listMainAxel.add(sentenceMainMartin4);
       listMainAxel.add(sentenceMainMartin5);
       listMainAxel.add(sentenceMainMartin6);
       listMainAxel.add(sentenceMainMartin7);
       listMainAxel.add(sentenceMainMartin8);

       listMainAxel.add(sentenceMainNolan1);
       listMainAxel.add(sentenceMainNolan2);
       listMainAxel.add(sentenceMainNolan3);
       listMainAxel.add(sentenceMainNolan4);
       listMainAxel.add(sentenceMainNolan5);
       listMainAxel.add(sentenceMainNolan6);
       listMainAxel.add(sentenceMainNolan7);
       listMainAxel.add(sentenceMainNolan8);
       
       listMainAxel.add(sentenceMainGuardian1);
       listMainAxel.add(sentenceMainGuardian2);
       listMainAxel.add(sentenceMainGuardian3);
       listMainAxel.add(sentenceMainGuardian4);
       listMainAxel.add(sentenceMainGuardian5);
       listMainAxel.add(sentenceMainGuardian6);
       listMainAxel.add(sentenceMainGuardian7);
       listMainAxel.add(sentenceMainGuardian8);

      listMainAxel.add(sentenceMainPG1);
       listMainAxel.add(sentenceMainPG2);
       listMainAxel.add(sentenceMainPG3);
       listMainAxel.add(sentenceMainPG4);
       listMainAxel.add(sentenceMainPG5);
       listMainAxel.add(sentenceMainPG6);
       listMainAxel.add(sentenceMainPG7);
       listMainAxel.add(sentenceMainPG8);
